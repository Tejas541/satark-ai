...
const styles = StyleSheet.create({
  ...
  brand: { color: "#F5F5F7", fontSize: 20, fontWeight: "800", letterSpacing: -0.4 },
  brandAI: { color: "#FF9500" },
  tagline: { color: "#A8A6B3", fontSize: 12.5, marginTop: 2 },
  title: { color: "#F5F5F7", fontSize: 32, lineHeight: 39, letterSpacing: -0.9, fontWeight: "800", marginTop: 31 },
  copy: { color: "#B7B5C0", fontSize: 15.5, lineHeight: 23, marginTop: 12 },
  divider: { height: 1, backgroundColor: "#292934", marginVertical: 28 },
  sectionLabel: { color: "#FF9500", fontWeight: "800", fontSize: 10, letterSpacing: 1.3, marginBottom: 13 },
  ...
  pointCopy: { flex: 1 },
  pointTitle: { color: "#F5F5F7", fontSize: 15.5, fontWeight: "800", marginTop: 1 },
  pointText: { color: "#A8A6B3", fontSize: 13.5, lineHeight: 20, marginTop: 4 },
  ...
  noticeText: { color: "#D2C99B", fontSize: 12.5, lineHeight: 18, flex: 1 },
});
